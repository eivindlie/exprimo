...
if __name__ == '__main__':
    ...
    placement = [
                     ...
                     2,    #  ['conv1'],
                     2,    #  ['pool1'],
                     2, 1, 1, 1, 1,    # ['res2a_branch1', 'res2a_branch2a', 'res2a_branch2b', 'res2a_branch2c', 'res2a'],
                     1, 1, 1, 1,    # ['res2b_branch2a', 'res2b_branch2b', 'res2b_branch2c', 'res2b'],
                     1, 1, 1, 1,    # ['res2c_branch2a', 'res2c_branch2b', 'res2c_branch2c', 'res2c'],
